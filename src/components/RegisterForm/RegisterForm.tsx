...
function RegisterForm({ handleCloseForm }: PropTypes) {
  return (
    <div className="fixed inset-0 bg-[rgba(0,_0,_0,_0.60)] flex justify-center items-center z-[20]">
      <div className="bg-white min-w-[375px] py-8 px-6 rounded-lg relative">
        <span className="text-[20px] font-medium leading-[1.5] text-center block">Đăng ký</span>
        <form className="my-7">
